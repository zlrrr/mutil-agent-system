...
|---|---|---|---|---|---|---|---|---|---|
| `rule` | `rule` | single | 6 | 17% | 83% | 5.0 | 1.0 | 0 | 3 |
| `rule` | `rule` | multi_no_critic | 6 | 17% | 83% | 5.0 | 1.0 | 0 | 0 |
| `rule` | `rule` | multi_with_critic | 6 | 100% | 100% | 5.8 | 2.3 | 54 | 5 |
...
| C4 | `rule` | `rule` | single | `sig-traffic-surge` | `sig-traffic-surge` | yes | 1 | 5 | closed |
...
| C4 | `rule` | `rule` | multi_no_critic | `sig-traffic-surge` | `sig-traffic-surge` | yes | 1 | 5 | closed |
...
| C4 | `rule` | `rule` | multi_with_critic | `sig-traffic-surge` | `sig-traffic-surge` | yes | 2 | 5 | closed |
